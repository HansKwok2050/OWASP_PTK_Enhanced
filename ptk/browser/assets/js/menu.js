...
jQuery(function () {
    ...
    $('#mainMenuWrapper').prepend(
        ...
        <div class="ui small inverted borderless menu" style="height:12px;margin: auto">
            <img src="assets/images/hacker_transparent.png" id="ptkicon">
            <div class="ui container" id="mainMenu">
                <a class="item" href="interceptor.html" data-history="interceptor">Interceptor</a>
                <a class="item" href="dirbuster.html" data-history="dirbuster">DirBuster</a>
                <a class="item" href="spider.html" data-history="spider">Spider</a>
                <a class="item" href="agentswitcher.html" data-history="agentswitcher">Agent Switcher</a>
                <a class="item" href="fuzzer.html" data-history="fuzzer">Fuzzer</a>
            </div>
        </div>
