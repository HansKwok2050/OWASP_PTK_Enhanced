...
import { ptk_interceptor } from "./ptk/background/interceptor.js" /* New function from Kwok Wing Hong */
import { ptk_dirbuster } from "./ptk/background/dirbuster.js" /* New function from Kwok Wing Hong */
import { ptk_spider } from "./ptk/background/spider.js" /* New function from Kwok Wing Hong */
import { ptk_agentswitcher } from "./ptk/background/agentswitcher.js" /* New function from Kwok Wing Hong */
import { ptk_fuzzer } from "./ptk/background/fuzzer.js" /* New function from Kwok Wing Hong */
...
export class ptk_app {
    constructor(settings) {
        ...
        browser.storage.local.get('pentestkit8_settings').then(function (result) {
            ...
            this.interceptor = new ptk_interceptor(this.settings.interceptor)

            this.dirbuster = new ptk_dirbuster()

            this.spider = new ptk_spider()

            this.agentswitcher = new ptk_agentswitcher()

            this.fuzzer = new ptk_fuzzer()
